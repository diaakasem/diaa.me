jQuery(document).ready(function ($) {
  ...
  $(".parallax").each(function () {
    ...
    $(window).scroll(function () {
      ...
      if (
        ...
        // the yPos is a negative value because we're scrolling it UP!
        var yPos =
          $window.scrollTop() / $self.data("speed") + $self.data("offsetY");
        // If this element has a Y offset then add it on
        if ($self.data("offsetY")) {
          yPos += $self.data("offsetY");
        }
          ...
          function () {
            $(".o-items-container").each(function () {
              ...
              $container.imagesLoaded(function () {
                ...
                var gutterWidth =
                  parseInt($container.attr("data-gutters")) || 0;
                var columnWidth =
                  ($container.width() - (nbCols - 1) * gutterWidth) / nbCols;
                $items.each(function () {
                  var $this = $(this);
              ...
              if ($('[data-target="' + id + '"]').length != 0) {
                var startfilter = $('[data-target="' + id + '"]')
                  .find(".active a")
                  .attr("data-filter");
  ...
  $("#contact-form").live("submit", function (event) {
    ...
    var sendemail = 1;
    $(this)
      .find("input.mandatory,textarea.mandatory")
      .each(function () {
  ...
  function o_conditional_scripts() {
    ...
    $("body")
      .removeClass("computer tablet phone smallscreen widescreen")
      .addClass(newDevice)
      .addClass(screenSize);
        ...
        if ($(".lightbox").length > 0) {
          $(".lightbox")
            ...
            .prettyPhoto({
              ...
              theme:
                "facebook" /* pp_default / light_rounded / dark_rounded / light_square / dark_square / facebook */,
              overlay_gallery: true /* If set to true, a gallery will overlay the fullscreen image on mouse over */,
              social_tools:
                '<div class="pp_social"><div class="twitter"><a href="http://twitter.com/share" class="twitter-share-button" data-count="none">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></div><div class="facebook"><iframe src="http://www.facebook.com/plugins/like.php?locale=en_US&href=' +
                location.href +
                '&amp;layout=button_count&amp;show_faces=true&amp;width=500&amp;action=like&amp;font&amp;colorscheme=light&amp;height=23" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:500px; height:23px;" allowTransparency="true"></iframe></div></div>' /* html code or false to disable */,
            });
    ...
    return this.each(function () {
        ...
        if (zoomimg || readmorelink) {
          ...
          if (zoomimg) {
            overlay +=
              '<a href="' +
              zoomimg +
              '" class="lightbox" data-fancybox-title="' +
              zoomtitle +
              '" rel="prettyPhoto[' +
              group +
              ']"><span class="glyphicons zoom_in" title="' +
              zoomi18n +
              '"><i></i></span></a>';
          }
          if (zoomvideo) {
            overlay +=
              '<a href="' +
              zoomvideo +
              '" class="lightbox iframe" data-fancybox-title="' +
              zoomtitle +
              '" rel="prettyPhoto[' +
              group +
              ']"><span class="glyphicons play" title="' +
              zoomi18n +
              '"><i></i></span></a>';
          }
          if (readmorelink) {
            overlay +=
              ...
              '" title="' +
              readmorei18n +
              '"><span class="glyphicons link"><i></i></span></a>';
          }
          overlay += "</div></div>";
      ...
      if (zoomimg || readmorelink || zoomvideo) {
        $(this).hover(
          function () {
            $(".actions", this).show();
            $(".overlay, .actions", this)
              .height($("img", this).height())
              .width($("img", this).width());
            $(".overlay", this)
              .css("opacity", 0)
              .stop()
              .animate({ opacity: 1 }, 400, "easeInOutCubic");
          },
          function () {
            $(".overlay", this)
              .stop()
              .animate({ opacity: 0 }, 200, "easeInOutCubic");
            $(".actions", this).hide();
          }
        );
      }
